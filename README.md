...
- **[Organization tools](src/tools/organizations/README.md)** — list organizations (`GET /organizations`), get, update, and delete an org (`GET` / `PATCH` / `DELETE /orgs/{org}`; delete is guarded with `confirm` / `dry_run`).
