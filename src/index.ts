...
import { registerGithubCheckDependabotSecurityUpdatesTool } from "./tools/github-check-dependabot-security-updates.js";
...
const server = new McpServer({ name: "github-mcp", version: "0.7.0" });
