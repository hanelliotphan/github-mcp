...
export function registerGithubGetRepoDependabotDismissalRequestTool(server: McpServer, octokit: Octokit): void {
    server.tool(
        ...
        async (input) => {
            try {
                ...
                const successPayload: GetRepoDependabotDismissalRequestSuccess = {
                    success: true,
                ...
                const failurePayload: GetRepoDependabotDismissalRequestFailure = {
                    success: false,
