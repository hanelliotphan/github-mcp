...
export function registerGithubListRepoDependabotDismissalRequestsTool(server: McpServer, octokit: Octokit): void {
    server.tool(
        ...
        async (input) => {
            ...
            try {
                if (input.all_pages === true) {
                    ...
                    const successPayload: ListRepoDependabotDismissalRequestsSuccess = {
                        success: true,
                ...
                const failurePayload: ListRepoDependabotDismissalRequestsFailure = {
                    success: false,
