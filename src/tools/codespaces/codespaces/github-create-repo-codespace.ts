...
export function registerGithubCreateRepoCodespaceTool(server: McpServer, octokit: Octokit): void {
    server.tool(
        "github_create_repo_codespace",
        "Create a codespace in a repository (POST /repos/{owner}/{repo}/codespaces). Optional ref, location, geo, machine, devcontainer_path, and other create fields. Returns HTTP 201 or 202. See GitHub REST Codespaces.",
        {
            owner: z
                .string()
                .min(1)
        ...
        async (input) => {
            ...
            try {
                ...
                const successPayload: CreateRepoCodespaceSuccess = {
                    success: true,
                ...
                const failurePayload: CreateRepoCodespaceFailure = {
                    success: false,
