...
export function registerGithubListAuthenticatedUserTeamsTool(server: McpServer, octokit: Octokit): void {
    server.tool(
        "github_list_authenticated_user_teams",
        "List teams for the authenticated user (GET /user/teams). " +
            "OAuth tokens require **`user`**, **`repo`**, or **`read:org`** scope. " +
            "Page pagination with **`per_page`**, **`page`**, **`all_pages`**, and **`max_pages`**. " +
            "See [List teams for the authenticated user](https://docs.github.com/en/rest/teams/teams?apiVersion=2026-03-10#list-teams-for-the-authenticated-user).",
        {
        ...
        async (input) => {
            ...
            try {
                if (input.all_pages === true) {
                    ...
                    const successPayload: ListAuthenticatedUserTeamsSuccess = {
                        success: true,
                        message: result.truncated
                            ...
                            : result.pagesFetched > 1
                              ...
                              : "Authenticated user teams listed successfully.",
                        teams,
                ...
                const successPayload: ListAuthenticatedUserTeamsSuccess = {
                    success: true,
                    message: "Authenticated user teams listed successfully.",
                ...
                const failurePayload: ListAuthenticatedUserTeamsFailure = {
                    success: false,
