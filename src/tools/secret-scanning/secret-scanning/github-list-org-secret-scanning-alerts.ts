...
import type { ListOrgSecretScanningAlertsSuccess, ListOrgSecretScanningAlertsFailure } from "../../../types.js";
...
export function registerGithubListOrgSecretScanningAlertsTool(server: McpServer, octokit: Octokit): void {
    server.tool(
        "github_list_org_secret_scanning_alerts",
        "List secret scanning alerts for an organization (GET /orgs/{org}/secret-scanning/alerts). Classic tokens need repo or security_events. See [List secret scanning alerts for an organization](https://docs.github.com/en/rest/secret-scanning/secret-scanning?apiVersion=2026-03-10#list-secret-scanning-alerts-for-an-organization).",
        {
        ...
        async (input) => {
            ...
            try {
                if (input.all_pages === true) {
                    ...
                    const result = await fetchAllPageLinkPages({
                        ...
                        fetchPage: async (page, pp) => {
                            const response = await octokit.rest.secretScanning.listAlertsForOrg({
                                org: input.org,
                ...
                ...(input.after !== undefined ? { after: input.after } : {}),
                    ...
                    const successPayload: ListOrgSecretScanningAlertsSuccess = {
                        success: true,
                ...
                const failurePayload: ListOrgSecretScanningAlertsFailure = {
                    success: false,
