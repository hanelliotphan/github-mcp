...
import type { ListOrgSecretScanningCustomPatternsSuccess, ListOrgSecretScanningCustomPatternsFailure } from "../../../types.js";
...
export function registerGithubListOrgSecretScanningCustomPatternsTool(server: McpServer, octokit: Octokit): void {
    server.tool(
        "github_list_org_secret_scanning_custom_patterns",
        "List secret scanning custom patterns for an organization (GET /orgs/{org}/secret-scanning/custom-patterns). Classic tokens need read:org. See [List organization custom patterns](https://docs.github.com/en/rest/secret-scanning/custom-patterns?apiVersion=2026-03-10#list-organization-custom-patterns).",
        {
        ...
        async (input) => {
            ...
            try {
                if (input.all_pages === true) {
                    ...
                    const successPayload: ListOrgSecretScanningCustomPatternsSuccess = {
                        success: true,
                ...
                const response = await octokit.request("GET /orgs/{org}/secret-scanning/custom-patterns", {
                    org: input.org,
                    ...filters,
                    per_page: perPage,
                    page
                ...
                const failurePayload: ListOrgSecretScanningCustomPatternsFailure = {
                    success: false,
