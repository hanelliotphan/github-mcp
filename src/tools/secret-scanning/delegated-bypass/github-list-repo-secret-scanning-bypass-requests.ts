...
import type { ListRepoSecretScanningBypassRequestsSuccess, ListRepoSecretScanningBypassRequestsFailure } from "../../../types.js";
...
export function registerGithubListRepoSecretScanningBypassRequestsTool(server: McpServer, octokit: Octokit): void {
    server.tool(
        "github_list_repo_secret_scanning_bypass_requests",
        "List secret scanning bypass requests for a repository (GET /repos/{owner}/{repo}/bypass-requests/secret-scanning). Classic tokens need security_events. See [List bypass requests for secret scanning for a repository](https://docs.github.com/en/enterprise-cloud@latest/rest/secret-scanning/delegated-bypass?apiVersion=2026-03-10#list-bypass-requests-for-secret-scanning-for-a-repository).",
        {
        ...
        async (input) => {
            ...
            try {
                if (input.all_pages === true) {
                    ...
                    const successPayload: ListRepoSecretScanningBypassRequestsSuccess = {
                        success: true,
                ...
                const response = await octokit.request("GET /repos/{owner}/{repo}/bypass-requests/secret-scanning", {
                ...
                const failurePayload: ListRepoSecretScanningBypassRequestsFailure = {
                    success: false,
