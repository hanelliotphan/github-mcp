...
import type { ListRepoSecretScanningAlertDismissalRequestsSuccess, ListRepoSecretScanningAlertDismissalRequestsFailure } from "../../../types.js";
        ...
        async (input) => {
            ...
            try {
                if (input.all_pages === true) {
                    ...
                    const successPayload: ListRepoSecretScanningAlertDismissalRequestsSuccess = {
                        success: true,
                ...
                const response = await octokit.request("GET /repos/{owner}/{repo}/dismissal-requests/secret-scanning", {
                ...
                const failurePayload: ListRepoSecretScanningAlertDismissalRequestsFailure = {
                    success: false,
