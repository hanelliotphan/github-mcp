...
import type { ListEnterpriseSecretScanningAlertDismissalRequestsSuccess, ListEnterpriseSecretScanningAlertDismissalRequestsFailure } from "../../../types.js";
        ...
        async (input) => {
            ...
            try {
                if (input.all_pages === true) {
                    ...
                    const successPayload: ListEnterpriseSecretScanningAlertDismissalRequestsSuccess = {
                        success: true,
                ...
                const response = await octokit.request("GET /enterprises/{enterprise}/dismissal-requests/secret-scanning", {
                    enterprise: input.enterprise,
                    ...filters,
                    per_page: perPage,
                    page
                ...
                const failurePayload: ListEnterpriseSecretScanningAlertDismissalRequestsFailure = {
                    success: false,
