...
export function registerGithubCreateUserProjectFieldTool(server: McpServer, octokit: Octokit): void {
    server.tool(
        "github_create_user_project_field",
        "Add a field to a user-owned project (POST /users/{username}/projectsV2/{project_number}/fields). " +
            ...
            "See [Add field to user owned project](https://docs.github.com/en/rest/projects/fields?apiVersion=2026-03-10#add-field-to-user-owned-project).",
        {
            username: z
                .string()
                .min(1)
        ...
        async (input) => {
            try {
                ...
                const successPayload: CreateUserProjectFieldSuccess = {
                    success: true,
                    message: "User project field created successfully.",
                ...
                const failurePayload: CreateUserProjectFieldFailure = {
                    success: false,
