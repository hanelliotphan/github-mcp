...
export function registerGithubGetEnvironmentActionsSecretTool(server: McpServer, octokit: Octokit): void {
    server.tool(
        "github_get_environment_actions_secret",
        "Get a single environment GitHub Actions secret without revealing its value (GET /repos/{owner}/{repo}/environments/{environment_name}/secrets/{secret_name}). " +
            ...
            "See [Get an environment secret](https://docs.github.com/en/rest/actions/secrets?apiVersion=2026-03-10#get-an-environment-secret).",
        {
            owner: z
                .string()
                .min(1)
        ...
        async (input) => {
            ...
            try {
                ...
                const successPayload: GetEnvironmentActionsSecretSuccess = {
                    success: true,
                ...
                const failurePayload: GetEnvironmentActionsSecretFailure = {
                    success: false,
