...
export function registerGithubListGithubHostedRunnersInGroupForOrgTool(server: McpServer, octokit: Octokit): void {
    server.tool(
        "github_list_github_hosted_runners_in_group_for_org",
        "List the GitHub-hosted runners in an organization runner group (GET /orgs/{org}/actions/runner-groups/{runner_group_id}/hosted-runners). " +
            ...
            "See [List GitHub-hosted runners in a group for an organization](https://docs.github.com/en/rest/actions/self-hosted-runner-groups?apiVersion=2026-03-10#list-github-hosted-runners-in-a-group-for-an-organization).",
        {
            org: z
                .string()
                .min(1)
        ...
        async (input) => {
            ...
            try {
                if (input.all_pages === true) {
                    ...
                    const successPayload: ListGithubHostedRunnersInGroupForOrgSuccess = {
                        success: true,
                ...
                const failurePayload: ListGithubHostedRunnersInGroupForOrgFailure = {
                    success: false,
