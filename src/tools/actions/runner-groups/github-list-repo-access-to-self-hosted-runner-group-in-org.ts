...
export function registerGithubListRepoAccessToSelfHostedRunnerGroupInOrgTool(server: McpServer, octokit: Octokit): void {
    server.tool(
        "github_list_repo_access_to_self_hosted_runner_group_in_org",
        "List the repositories with access to a self-hosted runner group configured in an organization (GET /orgs/{org}/actions/runner-groups/{runner_group_id}/repositories). " +
            ...
            "See [List repository access to a self-hosted runner group in an organization](https://docs.github.com/en/rest/actions/self-hosted-runner-groups?apiVersion=2026-03-10#list-repository-access-to-a-self-hosted-runner-group-in-an-organization).",
        {
            org: z
                .string()
                .min(1)
        ...
        async (input) => {
            ...
            try {
                if (input.all_pages === true) {
                    ...
                    const successPayload: ListRepoAccessToSelfHostedRunnerGroupInOrgSuccess = {
                        success: true,
                ...
                const failurePayload: ListRepoAccessToSelfHostedRunnerGroupInOrgFailure = {
                    success: false,
