...
export function registerGithubGetEnvironmentActionsVariableTool(server: McpServer, octokit: Octokit): void {
    server.tool(
        "github_get_environment_actions_variable",
        "Get a single GitHub Actions variable in a repository environment (GET /repos/{owner}/{repo}/environments/{environment_name}/variables/{name}). " +
            ...
            "See [Get an environment variable](https://docs.github.com/en/rest/actions/variables?apiVersion=2026-03-10#get-an-environment-variable).",
        {
            owner: z
                .string()
                .min(1)
        ...
        async (input) => {
            ...
            try {
                ...
                const successPayload: GetEnvironmentActionsVariableSuccess = {
                    success: true,
                ...
                const failurePayload: GetEnvironmentActionsVariableFailure = {
                    success: false,
