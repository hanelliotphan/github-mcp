...
**[Rules](rules/README.md)** tools (`GET /orgs/{org}/rulesets`, …) live in [`rules/`](rules/).
...
- [`github_delete_org_network_configuration`](network-configurations/README.md#github_delete_org_network_configuration)
- [`github_get_org_network_settings`](network-configurations/README.md#github_get_org_network_settings)
- [`github_list_org_roles`](organization-roles/README.md#github_list_org_roles)
- [`github_remove_all_org_roles_for_team`](organization-roles/README.md#github_remove_all_org_roles_for_team)
- [`github_assign_org_role_to_team`](organization-roles/README.md#github_assign_org_role_to_team)
- [`github_remove_org_role_from_team`](organization-roles/README.md#github_remove_org_role_from_team)
- [`github_remove_all_org_roles_for_user`](organization-roles/README.md#github_remove_all_org_roles_for_user)
...
- [`github_review_org_pat_request`](personal-access-tokens/README.md#github_review_org_pat_request)
- [`github_list_org_pat_request_repositories`](personal-access-tokens/README.md#github_list_org_pat_request_repositories)
- [`github_list_org_pats`](personal-access-tokens/README.md#github_list_org_pats)
...
- [`github_list_org_rulesets`](rules/README.md#github_list_org_rulesets)
- [`github_create_org_ruleset`](rules/README.md#github_create_org_ruleset)
- [`github_get_org_ruleset`](rules/README.md#github_get_org_ruleset)
- [`github_update_org_ruleset`](rules/README.md#github_update_org_ruleset)
...
- [`github_get_org_webhook_config`](webhooks/README.md#github_get_org_webhook_config)
- [`github_update_org_webhook_config`](webhooks/README.md#github_update_org_webhook_config)
...
- [`github_ping_org_webhook`](webhooks/README.md#github_ping_org_webhook)
...
- [`github_list_org_invitation_teams`](members/README.md#github_list_org_invitation_teams)
...
- [`github_check_org_public_membership_for_user`](members/README.md#github_check_org_public_membership_for_user)
- [`github_set_public_org_membership_for_auth_user`](members/README.md#github_set_public_org_membership_for_auth_user)
- [`github_remove_public_org_membership_for_auth_user`](members/README.md#github_remove_public_org_membership_for_auth_user)
