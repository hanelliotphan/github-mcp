...
import type { GetEnterpriseCopilotCustomAgentsSourceSuccess, GetEnterpriseCopilotCustomAgentsSourceFailure } from "../../../types.js";
...
export function registerGithubGetEnterpriseCopilotCustomAgentsSourceTool(server: McpServer, octokit: Octokit): void {
    server.tool(
        "github_get_enterprise_copilot_custom_agents_source",
        ...
        async (input) => {
            try {
                ...
                const successPayload: GetEnterpriseCopilotCustomAgentsSourceSuccess = {
                    success: true,
                ...
                const failurePayload: GetEnterpriseCopilotCustomAgentsSourceFailure = {
                    success: false,
