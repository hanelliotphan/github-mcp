...
import type { GetOrgCopilotContentExclusionSuccess, GetOrgCopilotContentExclusionFailure } from "../../../types.js";
...
export function registerGithubGetOrgCopilotContentExclusionTool(server: McpServer, octokit: Octokit): void {
    server.tool(
        "github_get_org_copilot_content_exclusion",
        ...
        async (input) => {
            try {
                ...
                const successPayload: GetOrgCopilotContentExclusionSuccess = {
                    success: true,
                    message: "Request completed successfully.",
                    org: input.org,
                    rules: toPlain(response.data),
                    request_id: requestId
                };
                return textAndData(successPayload);
            } catch (error: unknown) {
                const failurePayload: GetOrgCopilotContentExclusionFailure = {
                    success: false,
