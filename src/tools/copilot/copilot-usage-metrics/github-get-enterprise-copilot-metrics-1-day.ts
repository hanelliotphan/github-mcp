...
import type { GetEnterpriseCopilotMetrics1DaySuccess, GetEnterpriseCopilotMetrics1DayFailure } from "../../../types.js";
...
export function registerGithubGetEnterpriseCopilotMetrics1DayTool(server: McpServer, octokit: Octokit): void {
    server.tool(
        "github_get_enterprise_copilot_metrics_1_day",
        ...
        async (input) => {
            try {
                ...
                const successPayload: GetEnterpriseCopilotMetrics1DaySuccess = {
                    success: true,
                ...
                const failurePayload: GetEnterpriseCopilotMetrics1DayFailure = {
                    success: false,
