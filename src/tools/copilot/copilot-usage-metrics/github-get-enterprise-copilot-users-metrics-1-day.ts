...
import type { GetEnterpriseCopilotUsersMetrics1DaySuccess, GetEnterpriseCopilotUsersMetrics1DayFailure } from "../../../types.js";
...
export function registerGithubGetEnterpriseCopilotUsersMetrics1DayTool(server: McpServer, octokit: Octokit): void {
    server.tool(
        "github_get_enterprise_copilot_users_metrics_1_day",
        ...
        async (input) => {
            try {
                ...
                const successPayload: GetEnterpriseCopilotUsersMetrics1DaySuccess = {
                    success: true,
                ...
                const failurePayload: GetEnterpriseCopilotUsersMetrics1DayFailure = {
                    success: false,
