...
import type { GetEnterpriseCopilotUserTeamsMetrics1DaySuccess, GetEnterpriseCopilotUserTeamsMetrics1DayFailure } from "../../../types.js";
...
export function registerGithubGetEnterpriseCopilotUserTeamsMetrics1DayTool(server: McpServer, octokit: Octokit): void {
    server.tool(
        "github_get_enterprise_copilot_user_teams_metrics_1_day",
        ...
        async (input) => {
            try {
                ...
                const successPayload: GetEnterpriseCopilotUserTeamsMetrics1DaySuccess = {
                    success: true,
                ...
                const failurePayload: GetEnterpriseCopilotUserTeamsMetrics1DayFailure = {
                    success: false,
