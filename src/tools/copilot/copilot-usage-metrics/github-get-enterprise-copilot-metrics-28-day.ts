...
import type { GetEnterpriseCopilotMetrics28DaySuccess, GetEnterpriseCopilotMetrics28DayFailure } from "../../../types.js";
...
export function registerGithubGetEnterpriseCopilotMetrics28DayTool(server: McpServer, octokit: Octokit): void {
    server.tool(
        "github_get_enterprise_copilot_metrics_28_day",
        ...
        async (input) => {
            try {
                ...
                const successPayload: GetEnterpriseCopilotMetrics28DaySuccess = {
                    success: true,
                ...
                const failurePayload: GetEnterpriseCopilotMetrics28DayFailure = {
                    success: false,
