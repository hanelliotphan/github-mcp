...
import type { GetOrgCopilotMetrics28DaySuccess, GetOrgCopilotMetrics28DayFailure } from "../../../types.js";
...
export function registerGithubGetOrgCopilotMetrics28DayTool(server: McpServer, octokit: Octokit): void {
    server.tool(
        "github_get_org_copilot_metrics_28_day",
        ...
        async (input) => {
            try {
                ...
                const successPayload: GetOrgCopilotMetrics28DaySuccess = {
                    success: true,
                ...
                const failurePayload: GetOrgCopilotMetrics28DayFailure = {
                    success: false,
