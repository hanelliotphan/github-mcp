...
import type { GetOrgCopilotUserTeamsMetrics1DaySuccess, GetOrgCopilotUserTeamsMetrics1DayFailure } from "../../../types.js";
...
export function registerGithubGetOrgCopilotUserTeamsMetrics1DayTool(server: McpServer, octokit: Octokit): void {
    server.tool(
        "github_get_org_copilot_user_teams_metrics_1_day",
        ...
        async (input) => {
            try {
                ...
                const successPayload: GetOrgCopilotUserTeamsMetrics1DaySuccess = {
                    success: true,
                ...
                const failurePayload: GetOrgCopilotUserTeamsMetrics1DayFailure = {
                    success: false,
