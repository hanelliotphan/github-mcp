...
import type { RemoveOrgCopilotSpaceCollaboratorSuccess, RemoveOrgCopilotSpaceCollaboratorFailure } from "../../../types.js";
...
export function registerGithubRemoveOrgCopilotSpaceCollaboratorTool(server: McpServer, octokit: Octokit): void {
    server.tool(
        "github_remove_org_copilot_space_collaborator",
        "Remove a collaborator from an organization Copilot Space (DELETE /orgs/{org}/copilot-spaces/{space_number}/collaborators/{actor_type}/{actor_identifier}). Returns HTTP 204. See [Remove a collaborator from an organization Copilot Space](https://docs.github.com/en/rest/copilot-spaces/collaborators?apiVersion=2026-03-10#remove-a-collaborator-from-an-organization-copilot-space).",
        {
        ...
        async (input) => {
            try {
                ...
                const successPayload: RemoveOrgCopilotSpaceCollaboratorSuccess = {
                    success: true,
                ...
                const failurePayload: RemoveOrgCopilotSpaceCollaboratorFailure = {
                    success: false,
