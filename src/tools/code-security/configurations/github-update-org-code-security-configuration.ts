...
import type { UpdateOrgCodeSecurityConfigurationSuccess, UpdateOrgCodeSecurityConfigurationFailure } from "../../../types.js";
...
export function registerGithubUpdateOrgCodeSecurityConfigurationTool(server: McpServer, octokit: Octokit): void {
    server.tool(
        "github_update_org_code_security_configuration",
        "Update a code security configuration (PATCH /orgs/{org}/code-security/configurations/{configuration_id}). Classic tokens need write:org. See [Update a code security configuration](https://docs.github.com/en/rest/code-security/configurations?apiVersion=2026-03-10#update-a-code-security-configuration).",
        {
            org: z
                .string()
                .min(1)
        ...
        async (input) => {
            try {
                const response = await octokit.rest.codeSecurity.updateConfiguration({
                    org: input.org,
                ...
                const successPayload: UpdateOrgCodeSecurityConfigurationSuccess = {
                    success: true,
                ...
                const failurePayload: UpdateOrgCodeSecurityConfigurationFailure = {
                    success: false,
