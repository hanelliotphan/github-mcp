...
import type { CreateEnterpriseCodeSecurityConfigurationSuccess, CreateEnterpriseCodeSecurityConfigurationFailure } from "../../../types.js";
...
export function registerGithubCreateEnterpriseCodeSecurityConfigurationTool(server: McpServer, octokit: Octokit): void {
    server.tool(
        "github_create_enterprise_code_security_configuration",
        "Create a code security configuration for an enterprise (POST /enterprises/{enterprise}/code-security/configurations). Requires name and description. Classic tokens need admin:enterprise. See [Create a code security configuration for an enterprise](https://docs.github.com/en/rest/code-security/configurations?apiVersion=2026-03-10#create-a-code-security-configuration-for-an-enterprise).",
        {
            enterprise: z
                .string()
                .min(1)
        ...
        async (input) => {
            try {
                const response = await octokit.rest.codeSecurity.createConfigurationForEnterprise({
                ...
                const successPayload: CreateEnterpriseCodeSecurityConfigurationSuccess = {
                    success: true,
                    message: "Code security configuration created successfully.",
                ...
                const failurePayload: CreateEnterpriseCodeSecurityConfigurationFailure = {
                    success: false,
